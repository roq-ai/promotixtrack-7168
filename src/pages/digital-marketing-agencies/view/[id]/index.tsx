...
import { getDigitalMarketingAgencyById } from 'apiSdk/digital-marketing-agencies';
import { DigitalMarketingAgencyInterface } from 'interfaces/digital-marketing-agency';

function DigitalMarketingAgencyViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Digital Marketing Agency Details',
              isCurrent: true,
            },
          ]}
        />
...
)(DigitalMarketingAgencyViewPage);
